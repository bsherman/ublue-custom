...
RUN rpm-ostree override remove firefox firefox-langpacks && \
    ...
    rpm-ostree install distrobox evolution gnome-shell-extension-appindicator gnome-shell-extension-dash-to-dock \
        gnome-shell-extension-gsconnect gnome-tweaks inotify-tools just libratbag-ratbagd libretls nautilus-gsconnect \
        openssl shotwell tailscale wireguard-tools && \
